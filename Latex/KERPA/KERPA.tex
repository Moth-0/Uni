...
\begin{tikzpicture}[
  ...
  \begin{feynman}
    \node[label=below:(a) Direct Box] {};
    \diagram[layered layout, horizontal=v2 to v3] {
      i1 [particle=\(e^-\)] -- [fermion] v1,
      i2 [particle=\(\gamma\)] -- [photon] v2,
      v1 -- [photon, momentum=\(q_1\)] v2
         -- [fermion] v4
         -- [photon, momentum'=\(q_2\)] v3
         -- [fermion] v1,
      v4 -- [fermion] f1 [particle=\(e^-\)],
      v3 -- [photon] f2 [particle=\(\gamma\)],
    };
  \end{feynman}
\end{tikzpicture}
%
...
\begin{tikzpicture}[
  ...
  \begin{feynman}
    \node[label=below:(b) Crossed Box 1] {};
    \diagram[layered layout, horizontal=v2 to v3] {
      i1 [particle=\(e^-\)] -- [fermion] v1,
      i2 [particle=\(\gamma\)] -- [photon] v2,
      v1 -- [photon, momentum=\(q_1\)] v3
         -- [fermion] v2
         -- [fermion] v4
         -- [photon, momentum'=\(q_2\)] v1,
      v4 -- [fermion] f1 [particle=\(e^-\)],
      v3 -- [photon] f2 [particle=\(\gamma\)],
    };
  \end{feynman}
...
\begin{tikzpicture}[
  ...
  \begin{feynman}
    \node[label=below:(c) Crossed Box 2] {};
    \diagram[layered layout, horizontal=v2 to v3] {
      i1 [particle=\(e^-\)] -- [fermion] v1,
      i2 [particle=\(\gamma\)] -- [photon] v2,
      v1 -- [photon, momentum=\(q_1\)] v4
         -- [fermion] v3
         -- [fermion] v2
         -- [photon, momentum'=\(q_2\)] v1,
      v4 -- [fermion] f1 [particle=\(e^-\)],
