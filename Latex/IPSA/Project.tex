...
I have stated what GAI have been used for in the report. I have not coppied code just used it for inspiration. 
\\[3cm]
\hline 
\end{tabularx}
...
\begin{figure}[H]
    ...
    \caption{Visualization of the weights matrix at 5 epochs with batches of size 2000.}
    \label{fig:A}
\end{figure}
