...
Reflection upon solution: 
    I had a hard time understanding recursion, so while i get the functions to work, i
"""
...
def generate_tree(labels): 
    ...
    # Start recursion where both of the plit parts go throug function
...
import timeit
print("d: ")
# To make a tree i can go to 1 million before i hit the limit for ASCII charecters, 
# and it takes 1.5 seconds
n = 1_000_000
...
# For finding the distance i get 8.8 seconds for n=400 and 18 seconds for 500 
n = 400
